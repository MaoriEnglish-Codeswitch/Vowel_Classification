...
def main():
    ...
    origin_image_path = os.path.join(data_root, "spectrogram_4000_2_classes")
    ...
    train_root = os.path.join(data_root,'4000', "train")
    mk_file(train_root)
    for cla in emotion_class:

        mk_file(os.path.join(train_root, cla))

    val_root = os.path.join(data_root, '4000',"val")
    mk_file(val_root)
    for cla in emotion_class:
